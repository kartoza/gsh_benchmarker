...
gum style --foreground 240 "   • Results will be saved to pok_normplusklimaatverandering2100_50cm_results.csv"
gum style --foreground 240 "   • Gnuplot data: pok_normplusklimaatverandering2100_50cm_load.data"
