...
gum style --foreground 240 "   • Results will be saved to zonalstatistics_pet2022actueel_2024124_results.csv"
gum style --foreground 240 "   • Gnuplot data: zonalstatistics_pet2022actueel_2024124_load.data"
