...
gum style --foreground "$KARTOZA_HIGHLIGHT3" "   • Results will be saved to bkb_2024_results.csv"
gum style --foreground "$KARTOZA_HIGHLIGHT3" "   • Gnuplot data: bkb_2024_load.data"
